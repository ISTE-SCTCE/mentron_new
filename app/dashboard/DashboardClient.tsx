...
export function DashboardClient({
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col lg:grid lg:grid-cols-3 lg:gap-8 items-start w-full">
        {/* Left Column: Main Content */}
        <div className="lg:col-span-2 w-full">
          {/* ── Branded Header Bar with Logos ── */}
          <div style={{ 
            display: 'flex', alignItems: 'center', justifyContent: 'space-between', 
            padding: '24px 20px 0', ...a('0s') 
          }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
              <img src="/mentron_logo.png" alt="Mentron Logo" style={{ height: 28, width: 'auto', objectFit: 'contain' }} />
              <span style={{ fontFamily: 'Poppins', fontWeight: 900, fontSize: 18, color: '#2D2845', letterSpacing: -0.5 }}>MENTRON</span>
            </div>
            <img src="/iste_logo.png" alt="ISTE Logo" style={{ height: 32, width: 'auto', objectFit: 'contain' }} />
          </div>

          {/* ── Header ── */}
          <div
            style={{ padding: '24px 20px 8px', ...a('0.02s') }}
          >
          ...
          {/* ── Headline ── */}
          <div style={{ padding: '20px 20px 0', ...a('0.05s') }}>
          ...
          {/* ── XP Strip (Mobile Only) ── */}
          <div className="lg:hidden" style={{ padding: '16px 20px 0', ...a('0.1s') }}>
            <div style={{
              display: 'flex', alignItems: 'center', justifyContent: 'space-between',
              padding: '16px 24px',
          ...
          <div style={{ padding: '26px 20px 0', ...a('0.15s') }}>
            <p className="section-label" style={{ marginBottom: 14 }}>Featured Event</p>
            
            {/* WHAT THE HACK FEATURED GLOW CARD (Always links to offenso academy page) */}
            <Link href="/events/offenso" style={{ textDecoration: 'none' }}>
              <div style={{
                ...
                {/* Event Banner Image - Responsive height */}
              ...
              {[
                {
                  ...
                  statusBg: '#FFF3EE',
                  statusColor: '#FF8C69',
                  desc: 'Cybersecurity workshop exploring offensive security & hacking.',
                  img: 'https://istesctce.in/images/events-images/what%20the%20hack.jpeg',
                  link: '/events/offenso'
                },
                {
                  title: 'Mentron 2.0',
                ...
                const cardContent = (
                  <div style={{ width: 260, borderRadius: 20, overflow: 'hidden', background: '#FFFFFF', border: '1px solid rgba(108,99,255,0.06)', boxShadow: '0 8px 24px rgba(108,99,255,0.04)', height: '100%', display: 'flex', flexDirection: 'column' }}>
                    {/* Event Image */}
                ...
                if (evt.link.startsWith('/')) {
                  return (
                    <Link key={idx} href={evt.link} style={{ textDecoration: 'none', display: 'block', flexShrink: 0 }}>
                      {cardContent}
                    </Link>
                  );
                } else {
                  return (
                    <a key={idx} href={evt.link} target="_blank" rel="noopener noreferrer" style={{ textDecoration: 'none', display: 'block', flexShrink: 0 }}>
                      {cardContent}
                    </a>
                  );
                }
          ...
          {/* ── Featured Courses ── */}
          <div style={{ padding: '26px 20px 0', ...a('0.22s') }}>
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 12 }}>
        ...
        <div className="lg:col-span-1 w-full space-y-6 lg:sticky lg:top-8 mt-6 lg:mt-0 lg:px-4">
          {/* ── XP Strip (Desktop Only) ── */}
          <div className="hidden lg:block" style={{ padding: '0 20px', ...a('0.1s') }}>
            <div style={{
              display: 'flex', alignItems: 'center', justifyContent: 'space-between',
              padding: '16px 24px',
              background: 'linear-gradient(135deg, #8B7FFF, #6C63FF)',
          ...
          {/* ── Contribute ── */}
          <div style={{ padding: '0 0 0', ...a('0.38s') }}>
            <div
