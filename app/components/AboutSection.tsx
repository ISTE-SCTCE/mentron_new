    ...
    return (
        <section className="w-full relative z-20 py-24 md:py-32 flex justify-center bg-transparent shrink-0">
            <div className="max-w-7xl w-full px-4 md:px-8 lg:px-16 flex">
                <div className="border-l-4 border-[#00d0ff] pl-8 space-y-8 max-w-5xl translate-x-4 md:translate-x-0">
                    <h2 className="text-4xl md:text-5xl font-black text-[#2d3a4d] tracking-wide">
                        About Mentron
                    </h2>
                    <div className="space-y-6 text-gray-300 text-lg md:text-xl leading-relaxed font-medium text-justify md:text-left">
                        <p>
