...
/// Deep Space Navy background ΓÇö the premium sweet spot between pure black and colored.
...
class ExecLiquidBackground extends StatelessWidget {
  final Widget? child;
  const ExecLiquidBackground({super.key, this.child});
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      // Deep space navy ΓÇö the signature color
      color: const Color(0xFF080B14),
      child: RepaintBoundary(
        child: Stack(
          fit: StackFit.expand,
          children: [
            // Rich purple nebula ΓÇö top left (larger, more saturated)
            Positioned(
              top: -100,
              left: -100,
              child: Container(
            ...
            // Electric cyan ΓÇö bottom right
            Positioned(
              bottom: -80,
              right: -80,
              child: Container(
